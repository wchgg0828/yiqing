<!--
 * @Autor: wencaihao
 * @Date: 2022-12-08 21:27:23
 * @LastEditors: wencaihao
 * @LastEditTime: 2022-12-09 22:07:25
 * @aim: 
-->
<template>
    <div class="case-num">
        <div class="container">
            <div class="title">
                <span>截至 {{ formatData(caseNumData.modifyTime) }} 国内数据统计</span>
            </div>
        </div>
        <div class="num">
            <ul class="count">
                ...
                <li>
                    <div class="create-item">
                        <div class="create-count">
                            <b>
                                较昨日<em style="color: rgb(162, 90, 78)">+{{ caseNumData.suspectedIncr }}</em>
                            </b>
                        </div>
                ...
                <li>
                    <div class="create-item">
                        <div class="create-count">
                            <b>
                                较昨日<em style="color: rgb(174, 33, 44)">+{{ caseNumData.curedIncr }}</em>
                            </b>
                        </div>
                ...
                <li>
                    <div class="create-item">
                        <div class="create-count">
                            <b>
                                较昨日<em style="color: rgb(93, 112, 146)">+{{ caseNumData.deadIncr }}</em>
                            </b>
                        </div>
                ...
                <li>
                    <div class="create-item">
                        <div class="create-count">
                            <b>
                                较昨日<em style="color: rgb(40, 183, 163)">{{ caseNumData.seriousIncr }}</em >
                            </b>
                        </div>
